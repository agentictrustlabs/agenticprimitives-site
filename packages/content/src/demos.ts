...
export const DEMOS: readonly Demo[] = [
  ...
  },
  {
    ...
    blurb:
      'field.faithnet.io is Faithnet Field Operations: local-first workspaces for field teams (e.g. Somali Corridor). Who belongs, who may speak for the organization, and where the work sits are ontology-backed — not free-text labels. A People Group (Somalis) is the ethno-linguistic unit of share; a People Community is a concrete gathering of that people in a place. Circles (Community, Discovery Group) and Churches are typed oikos structures on that community — relationship rings the team fosters, not generic “groups.” Projects and locations bind the team’s “where to share.” Membership comes from the ontology (a team has members); stewardship grants gate acts that speak for the organization. The tab title stays discreet — under some postures the app name itself is a disclosure.',
    links: [
      {
        ...
        note: 'live workspace overview',
      },
      { href: 'https://field.faithnet.io', label: 'field.faithnet.io' },
    ],
    proves: [
      'People Group ≠ People Community ≠ Circle ≠ Church — four modelled kinds, never collapsed into one “group” string',
      'Membership is not a grant — a member sees; a steward acts',
      'Vaults hold custody; projections (overview, circles, map) cross boundaries without exporting raw field reality',
    ],
    shot: {
      src: '/shots/field-somali-corridor.jpg',
      alt: 'Field Operations — Somali Corridor Team overview: circles (Community, Discovery Group, Church), people group Somalis, team members',
      caption: 'field.faithnet.io — Somali Corridor Team · People Group: Somalis · Circles & Churches as typed structures',
      width: 1024,
      height: 365,
    },
    script: [
      { do: 'Open the Somali Corridor Team overview (link above); sign in if asked.', expect: 'Workspace scoped to that team — recent activity, circles, where-to-share, team roster.' },
      { do: 'Read Circles & groups: Community, Discovery Group, Church.', expect: 'Typed circle/church kinds on the field ontology — not ad-hoc folders.' },
      { do: 'Check Where to share: People Group, Project, Location.', expect: 'People Group (Somalis) and place bind the team’s share target; community is the concrete gathering under that people.' },
      { do: 'Open Ask (if available): “Who are the members of my organization?” Then try an act that speaks for the org.', expect: 'Members resolved from ontology. Stewardship-gated acts refuse with the grant named — member ≠ steward.' },
    ],
    signInAs: 'alice',
    minutes: 5,
  },
