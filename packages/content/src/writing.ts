...
export const WRITING: readonly Writing[] = [
  ...
  { slug: 'what-registries-are-built-from', title: 'Be what registries are built from', description: 'Day 12. Many registries will exist. Ship the kit, not a tenant of one.', kind: 'series', date: '2026-09-12', day: 12, week: 'Trust, discovery, privacy', file: '12-what-registries-are-built-from.md', cover: '/writing/day-12-registry-kit.png' },
  { slug: 'resolution-is-not-authority', title: 'Resolution is not authority', description: 'Day 13. Being findable is never permission to act.', kind: 'series', date: '2026-09-12', day: 13, week: 'Trust, discovery, privacy', file: '13-resolution-is-not-authority.md', cover: '/writing/day-13-resolution-not-authority.png' },
  { slug: 'two-tiers', title: 'Two tiers of knowledge that never meet', description: 'Day 14. Public KB vs private vault. A generated query is never why something is disclosed.', kind: 'series', date: '2026-09-12', day: 14, week: 'Trust, discovery, privacy', file: '14-two-tiers.md', cover: '/writing/day-14-two-tiers.png' },
  { slug: 'vault-is-the-record', title: 'The vault is the record; everything else is a cache', description: 'Day 15. If the runtime were wiped, the loss is a rebuild — never a bereavement.', kind: 'series', date: '2026-09-13', day: 15, week: 'Trust, discovery, privacy', file: '15-vault-is-the-record.md', cover: '/writing/day-15-vault-is-the-record.png' },
  {
  ...
  { slug: 'coordination-vs-orchestration', title: 'Coordination is not orchestration', description: 'Day 17. Work between agents is a different plane from work inside one run.', kind: 'series', date: '2026-09-14', day: 17, week: 'Acting', file: '17-coordination-vs-orchestration.md', cover: '/writing/day-17-coordination-vs-orchestration.png' },
  { slug: 'behaviour-generated-authority-never', title: 'Behaviour is generated; authority never is', description: 'Day 18. A playbook tells the agent how. It is consulted by no verifier.', kind: 'series', date: '2026-09-14', day: 18, week: 'Acting', file: '18-behaviour-generated-authority-never.md', cover: '/writing/day-18-behaviour-generated.png' },
  { slug: 'receipts-that-travel', title: 'Receipts that travel with the agent', description: 'Day 19. Evidence is the owner’s, not the platform’s.', kind: 'series', date: '2026-09-14', day: 19, week: 'Acting', file: '19-receipts-that-travel.md', cover: '/writing/day-19-receipts-that-travel.png' },
  { slug: 'https-mtls-admission', title: 'HTTPS required, mTLS optional, admission always', description: 'Day 20. A certificate is transport evidence, never authority.', kind: 'series', date: '2026-09-14', day: 20, week: 'Acting', file: '20-https-mtls-admission.md', cover: '/writing/day-20-admission-always.png' },
  { slug: 'what-we-owe', title: 'What we got wrong, and the numbers we owe', description: 'Day 21. Honest gaps, and an invitation to be corrected.', kind: 'series', date: '2026-09-14', day: 21, week: 'Close', file: '21-what-we-owe.md', cover: '/writing/day-21-what-we-owe.png' },
];
