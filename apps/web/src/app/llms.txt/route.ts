...
- [A critical review](${SITE.url}/thesis/review): the project's own critical reading of the thesis — the three testable claims inside the vision; the platform as the real competitor; the five markets against what exists (faith has evidence, finance the mechanics, three have no domain model); the thirteen bets and eleven principles against the code; what the thesis does not say; what would prove it; what a doubter is right about
