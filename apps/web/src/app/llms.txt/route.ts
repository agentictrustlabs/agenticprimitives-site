...
- [Versus · who could assemble it](${SITE.url}/compare/assemble): competitive analysis of the horizontal agentic market, dated September 2026 with a projection to early 2027 — the fifteen functions of a substrate-and-estate and what we run them on (Cloudflare); the field dated (Okta Agent SSO / XAA GA Aug 2026, Entra Agent ID and Agent 365, AWS AgentCore Policy and Consent Portal, Cloudflare OS / Wallets / cloudflare.pay / Identity-Aware AI Gateway, Google AP2, Anthropic Managed Agents, OpenAI Agents SDK, Visa TAP and Mastercard Agent Pay, ERC-8004 and x402, Keycard / Scalekit, AGNTCY / NANDA / MCP registry, LangSmith Deployment); four assemblies that could produce something similar (Cloudflare-native, enterprise identity, hyperscaler platform, Web3) with what each would have and lack; a function-by-function scorecard; twelve deficiencies dated to the window; what no assembly produces
