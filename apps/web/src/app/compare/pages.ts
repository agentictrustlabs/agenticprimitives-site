...
export const COMPARE_PAGES = [
  { href: '/compare', label: 'The composition', sub: 'Every layer has a peer; nobody has all of them' },
  ...
  { href: '/compare/replaces', label: 'What it replaces', sub: '77 packages · 33 contracts · the bill of materials' },
