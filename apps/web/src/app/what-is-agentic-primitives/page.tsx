...
export default function WhatIs() {
  return (
    <>
      ...
      <CTA title="Read the argument, then run it." body="Twenty-one days, one idea each, and six live apps that exercise every layer." primary={{ href: '/writing', label: 'The missing layer — the series' }} secondary={{ href: '/demos', label: 'Demos' }} />
    </>
  );
}
