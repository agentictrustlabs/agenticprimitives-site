...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages: MetadataRoute.Sitemap = [
    ...
    ...['/platform', '/substrate', '/examples/game-night', '/compare', '/developers', '/ontology', '/build', '/build/point-at', '/build/demo-people', '/build/flow', '/build/gates', '/writing', '/brand', '/ns'].map((p) => ({
      url: `${SITE.url}${p}`,
