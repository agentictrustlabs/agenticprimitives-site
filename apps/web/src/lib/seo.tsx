  ...
  return [
    {
      ...
      '@id': orgId,
      name: SITE.name,
      alternateName: ['agenticprimitives', 'AgenticPrimitives', 'agenticprimitives.dev'],
      legalName: SITE.org,
      url: SITE.url,
      logo: { '@type': 'ImageObject', url: `${SITE.url}/brand/icon-512.png`, width: 512, height: 512 },
      sameAs: [SITE.githubOrg, SITE.github, SITE.npm, SITE.linkedinCompany, SITE.richCanvas],
      foundingDate: '2025',
      founder: { '@id': `${SITE.url}/#founder` },
      location: { '@type': 'Place', address: { '@type': 'PostalAddress', addressLocality: 'Erie', addressRegion: 'CO', addressCountry: 'US' } },
      email: 'hello@agenticprimitives.dev',
      description: 'Agentic Primitives is the open-source trust substrate for AI agents: identity that can sign, authority as a revocable grant, receipts the owner carries.',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Person',
      ...
      worksFor: { '@id': orgId },
      url: `${SITE.url}/about`,
      sameAs: [SITE.linkedinAuthor, SITE.authorUrl, SITE.richCanvas],
    },
    {
      '@context': 'https://schema.org',
      '@type': 'WebSite',
      ...
      url: SITE.url,
      name: SITE.name,
      alternateName: ['agenticprimitives', 'agenticprimitives.dev'],
    ...
    },
    {
      ...
      name: SITE.name,
      alternateName: 'agenticprimitives',
